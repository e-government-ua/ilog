...
public class AccessDataServiceImpl implements AccessDataService {
    ...
    public String setAccessData(String sContent) {
        LOG.info("(sContent={}) sContent={} sContent={} sContent={}", sContent);
        LOG. info ("(sContent={}) sContent={} sContent={} sContent={}", sContent);
        LOG.trace ("(sContent={}) sContent={} sContent={} sContent={}", sContent);
        LOG.    debug("(sContent={}) sContent={} sContent={} sContent={}", sContent);
        LOGGER.warn("(sContent={}) sContent={} sContent={} sContent={}", sContent);
        LOGGER .   error (   "(sContent={}) sContent={} sContent={} sContent={}", sContent);
        ...
        LOG.info("(sKey={}) sKey={} sKey={} sKey={}", sKey);
        //log.info("(sData(check)={}) getAccessData(sKey)={} getAccessData(sKey)={} getAccessData(sKey)={}", getAccessData(sKey));
        return sKey;
    }
